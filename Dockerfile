...
MAINTAINER Anirudha Vishvakarma <anirudha237@gmail.com>
...
COPY jobs/spark_demo_job/setup.sh /tmp/job/setup.sh
RUN ["chmod", "+x", "/tmp/job/setup.sh"]
RUN /tmp/job/setup.sh

# Expose ports for monitoring.
# SparkContext web UI on 4040 -- only available for the duration of the application.
# Spark master’s web UI on 8080.
# Spark worker web UI on 8081.
EXPOSE 4040 8080 8081 9000